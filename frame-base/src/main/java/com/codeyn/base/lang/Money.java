 ...
 * <li>推荐使用Money，不建议直接使用BigDecimal的原因之一在于，3
 ...
 * 
 * @author wei.tandw
 * @version $Id: Money.java,v 1.1 2013-08-28 14:01:56 wei.tandw Exp $
 */
public class Money implements Serializable, Comparable<Object> {
     ...
     * 构造器。
     * <p>
     * 创建一个具有金额<code>amount</code>分和缺省币种的货币对象。
     * 
     * @param cent
     *            金额，以分为单位。
     */
    ...
    public int compareTo(Object other) {
        Money target = (Money) other;
        int result = 0;
        if (this.cent > target.getCent()) {
            result = 1;
        } else if (this.cent < target.getCent()) {
            result = -1;
        }
